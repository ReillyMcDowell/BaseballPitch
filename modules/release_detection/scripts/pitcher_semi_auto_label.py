...
class SemiAutoLabeler:
    ...
    def save_label(self, box):
        ...
        # Save label
        label_path = (
            f"{OUTPUT_BASE}/labels/{self.split}/"
        ...
        for frame_idx in frames_to_label:
            ...
            while True:
                ...
                info_text = (
                    ...
                    f"Progress: {progress_idx}/{len(frames_to_label)}"
                )
                cv2.putText(
                ...
                img_path = (
                    f"{OUTPUT_BASE}/images/{self.split}/"
